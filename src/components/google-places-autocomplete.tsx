...
const GOOGLE_MAPS_API_KEY = 'AIzaSyD6QtxwW3aWYrWROP1CD73vlFqgMU9OhjM';
...
interface GooglePlacesAutocompleteProps {
    handleAddressChange?: (e: never) => void;
}
...
export default function GooglePlacesAutocomplete(props) {
    ...
    useEffect(() => {
        ...
        fetch({ input: inputValue, types: ['premise'], fields: ['address_component, geometry'] }, (results?: readonly PlaceType[]) => {
            if (active) {
    ...
    return (
        <Autocomplete
            ...
            onChange={async (event: any, newValue: PlaceType | null) => {
                ...
                if (newValue) {
                    fetchPlaceDetails(newValue.place_id, (details) => {
